public class GuessGame {
    ...
    public void startGame(){
        ...
        int targetNumber = 8;//(int) (Math.random() * 10);
        System.out.println("Estou pensando em um número entre 0 e 9...");
        
        while(true){
            System.out.println("O número a adivinhar é " + targetNumber);
            System.out.print("Jogador 1, digite um palpite de 0 a 9: ");  
            p1.guess();
            System.out.print("Jogador 2, digite um palpite de 0 a 9: ");  
            p2.guess();
            System.out.print("Jogador 3, digite um palpite de 0 a 9: ");  
            p3.guess();
            ...
            if (p1isRight || p2isRight || p3isRight) {
                ...
                System.out.println("Os jogadores tarão que tentar novamente.");
            }
