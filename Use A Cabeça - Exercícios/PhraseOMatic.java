public class PhraseOMatic{
	public static void main(String[] args){
		...
		String[] wordListTwo = {"habilitado", "adesivo", "valor agregado", "orientação", "cental", "distribuído", "agrupado", "solidificado", "independente da máquina", "posicionado", "em rede", "dedicado", "alavancado", "alinhado", "destinado", "compartilhado", "cooperativo", "acelerado"};
